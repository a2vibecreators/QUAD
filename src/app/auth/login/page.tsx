      ...
      <div className="max-w-md w-full space-y-8 bg-white rounded-2xl shadow-2xl p-8">
        ...
        {!showEmailForm ? (
          ...
          <div className="space-y-4">
            ...
            <button
              onClick={() => {
                // TODO: Implement email code flow
                alert('Email code authentication coming soon!');
              }}
              disabled={!email || isLoading !== null}
              className="w-full px-4 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 disabled:from-gray-400 disabled:to-gray-400 text-white font-medium rounded-lg transition-all disabled:cursor-not-allowed"
            >
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-gray-400">
            Self-hosted enterprise platform • Version 1.0.0
          </p>
        </div>
